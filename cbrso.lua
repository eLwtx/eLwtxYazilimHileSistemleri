...
local RayfieldFolder = "eLwtxCBRO"
local ConfigurationFolder = RayfieldFolder.."/Configurations"
local ConfigurationExtension = ".rfld"
local settingsTable = {
	General = {
		-- if needs be in order just make getSetting(name)
		rayfieldOpen = {Type = 'bind', Value = 'K', Name = 'Menu tus atamasi'},
		-- buildwarnings
		-- rayfieldprompts

	},
	System = {
		usageAnalytics = {Type = 'toggle', Value = true, Name = 'Analitik'},
	}
}
...
local function loadSettings()
	...
	if not success then 
		if writefile then
			warn('eLwtxCBRO had an issue accessing configuration saving capability.')
		end
	end
end
